...
function add_del_table() {
    while true; do
        ovs-ofctl del-flows br-ovs "table=1" &
        add_table0_5 &
        add_table5 &

        ovs-ofctl del-flows br-ovs "table=2" &
        add_table0_6 &
        add_table6 &

        ovs-ofctl del-flows br-ovs "table=3" &
        add_table0_7 &
        add_table7 &

        ovs-ofctl del-flows br-ovs "table=4" &
        add_table0_8 &
        add_table8 &

        sleep 0.01

        ovs-ofctl del-flows br-ovs "table=5" &
        add_table0_1 &
        add_table1 &
        
        ovs-ofctl del-flows br-ovs "table=6" &
        add_table0_2 &
        add_table2 &

        ovs-ofctl del-flows br-ovs "table=7" &
        add_table0_3 &
        add_table3 &

        ovs-ofctl del-flows br-ovs "table=8" &
        add_table0_4 &
        add_table4 &
